...
#$(call inherit-product-if-exists, vendor/alcatel/5010/5010-vendor.mk) useless for building recovery only

#DEVICE_PACKAGE_OVERLAYS += device/alcatel/5010/overlay useless for building recovery only
